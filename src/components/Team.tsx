...
import SanatImg from "@/assets/sanat.png";
import SivramImg from "@/assets/sivram.png";
import PriyaImg from "@/assets/priya.png";
import PranayImg from "@/assets/pranay.png";
import BalajiImg from "@/assets/Balaji.png";
              ...
              <div className="flex gap-4 overflow-x-auto scrollbar-hide pb-2">
                {members.map((m, index) => (
                  <div
                    ...
                    className={`flex-shrink-0 cursor-pointer transition-all duration-300 ${selectedMember === index
